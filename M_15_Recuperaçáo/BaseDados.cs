...
namespace M_15_Recuperaçáo
{
    public class BaseDados
    {
        ...
        private void CriarBD()
        {
            ...
            sqlConnection.ChangeDatabase(NomeBD);
            //criar as tabelas
            sql = @"create table cacadores(
	                    ncacador int primary key,
	                    nome varchar(40) not null,
	                    data_nasc date,
                    );
                    create table armas(
	                    narma int primary key,
                    ...
                    create table pontuacao(
	                    npontuacao int primary key,
	                    ncacador int references cacadores(ncacador),
	                    narma int references armas(narma),
	                    data_pontuacao date,
                    );";
